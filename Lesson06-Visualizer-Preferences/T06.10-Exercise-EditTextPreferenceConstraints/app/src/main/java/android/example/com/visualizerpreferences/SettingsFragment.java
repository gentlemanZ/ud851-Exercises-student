...
public class SettingsFragment extends PreferenceFragmentCompat implements
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        Toast errorToast = Toast.makeText(getContext(),"Plese enter a number between 0.1  and 3",Toast.LENGTH_LONG);

        String sizeFactor = getString(R.string.pref_size_key);
        if (preference.getKey().equals(sizeFactor)){
